    ...
    <body>
        ...
        <div class="menu-bar" id="menu-bar">
            <ul>
                ...
                <li><a href="users.php"><i class="fa fa-users" aria-hidden="true"></i> تصفح المعلنين</a></li>
        ...
        <nav class="navbar" id="navbar">
            <div class="container-fluid">
                ...
                <div class="nav <?php if(isset($_COOKIE['user_login']) || isset($_SESSION['user_email'])) echo "avatar"; ?>">
                    ...
                    <ul class="navbar-nav reg-login " <?php if(!isset($_COOKIE['user_login']) && !isset($_SESSION['user_email'])) echo "style='display:inline-block'";?>>
                        <?php 
                            /* 
                            ...
                            if(!isset($_COOKIE['user_login']) && !isset($_SESSION['user_email'])){
                                ...
                                */ 
                                ...
                                if($result['user_image'] != ""){
                                    ...
                                    echo "<img class='img-responsive' src='Profile/Layout/Images/users-images/$user_image' alt='$user_image'>";
                                }
                                else{
                                ...
                                echo "
                                    ...
                                    <div class='dropdown' id='dropdown'>
                                        <ul>
                                            ...
                                            <li>
                                                <a href='Profile/personal-profile.php?account'>
                                                    <i class='fa fa-user-o'></i> الملف الشخصي
                                                </a>
                                            </li>
                                            <li>
                                                <a href='Profile/personal-profile.php?my-ads&page=1'>
                                                    <i class='fa fa-briefcase'></i> إعلاناتي
                                                </a>
                                            </li>
                                            <li>
                                                <a href='Profile/personal-profile.php?balance'>
