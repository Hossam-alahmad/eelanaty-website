...
<div class="chat-box">
    <div class="title">
        ...
        <div class="username pull-right">
            ...
            <span><i class='fa fa-circle <?php echo $class; ?>'></i> <?php echo $status; ?></span>
        </div>
        <a href="show-ads.php?p_id=<?php echo $p_id; ?>" class="close" id="close-chat" data-text="<?php echo $user_id?>">X</a>
    </div>
